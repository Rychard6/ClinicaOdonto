...
export default function SecretariasPage() {
  ...
  const chartData = {
    labels: ["Secretaria A", "Secretaria B", "Secretaria C", "Secretaria D"],
    datasets: [
      {
  ...
  const assignPermissions = (userId: number) => {
  ...
  const topPerformers = chartData.labels
    .map((label, index) => ({
      secretaria: label,
      consultas: chartData.datasets[0].data[index],
    }))
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-4">
            Consultas Confirmadas por Secretaria
          </h2>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <ul>
            {topPerformers.map((item, index) => (
              ...
              >
                <span className="text-gray-700">{item.secretaria}</span>
